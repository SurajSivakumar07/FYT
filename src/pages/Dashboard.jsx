...
export default function Dashboard() {
  ...
  return (
    <div className="flex flex-col items-center px-3 py-2 bg-gradient-to-br from-blue-50 via-white to-purple-100 h-[100dvh] w-full overflow-x-hidden overflow-y-hidden">
      {/* Cards */}
